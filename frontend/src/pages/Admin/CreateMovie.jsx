import {useCreateMovieMutation,useUploadImageMutation} from "../../redux/api/movieApiSlice"
import {useListGenresQuery} from "../../redux/api/genreApiSlice"
...
const CreateMovie = () => {
  ...
  const { data: genres, isLoading: isLoadingGenres } = useListGenresQuery();
