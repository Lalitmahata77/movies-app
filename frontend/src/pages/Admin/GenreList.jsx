import {useCreateGenreMutation,useDeletGenreMutation,useUpdateGenreMutation,useListGenresQuery} from "../../redux/api/genreApiSlice"
import Modal from "../../components/Modal"
import GenreForm from "../../components/FormGenre"
...
const GenreList = () => {
    ...
    const {data: genres, refetch} = useListGenresQuery()
    const [createGenre] = useCreateGenreMutation()
    const [updateGenre] = useUpdateGenreMutation()
    const [deleteGenre] = useDeletGenreMutation()
