...
import {useAddMovieReviesMutation,useReadMovieQuery} from "../../redux/api/movieApiSlice"
...
const MovieDetails = () => {
    ...
    const {data : movie, refetch} = useReadMovieQuery(movieId)
    const {userInfo} = useSelector((state)=> state.auth)
    const [createReview, {isLoading : loadingMovieReview}] = useAddMovieReviesMutation()
